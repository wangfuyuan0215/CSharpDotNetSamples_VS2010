...
namespace BasicDemo
{
    public partial class Form1 : Form
    {
        ...
        public void ReceiveThreadProcess()
        {
            ...
            //CFrameoutEx pcFrameInfoEx = new CFrameoutEx();
            //byte[] pData = new byte[2048 * 2048 * 100];
            while (m_bGrabbing)
            {
                //int nRet2 = m_MyCamera.GetOneFrameTimeout(pData, 1024*1024*400, ref pcFrameInfoEx, 1000);
